...
const Filters = () => {
  const { selectedGenre, setMovieDetails, selectedMode } =
    ...
    const fetchByGenre = async () => {
      try {
        const res = await axios(
          `${API_URL}?s=${selectedGenre}&apikey=${API_KEY}`,
        );
  ...
  return (
    <div>
      <div
        style={{
          backgroundColor: selectedMode === "Dark" ? "#2f2f2f" : "#a00000",
          padding: 10,
          color: selectedMode === "Dark" ? "#a00000" : "#fff",
        }}
      >
        <p>
